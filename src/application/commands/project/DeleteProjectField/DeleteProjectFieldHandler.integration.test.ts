...
describe('DeleteProjectFieldHandler', () => {
  ...
  it('deletes field with no user data', async () => {
    ...
    const result = await handler.execute(
      new DeleteProjectFieldCommand(fieldId, projectId, clientId, false),
    )
  ...
  it('throws ConflictError when field has data and force=false', async () => {
    ...
    await updateUserField.execute(
      new UpdateUserFieldCommand(userId, projectId, fieldId, 'some value'),
    )
  ...
  it('deletes field with data when force=true', async () => {
    ...
    const result = await handler.execute(
      new DeleteProjectFieldCommand(fieldId, projectId, clientId, true),
    )

...
```json
{
  ...
  "main": "dist/main.js",
  "scripts": {
    "dev": "node -r dotenv/config -r tsconfig-paths/register -r ts-node/register/transpile-only src/main.ts",
    "build": "tsc && tsc-alias",
...
# File: src/contexts/InfrastructureContex.ts
...
# File: src/presentation/http/controllers/ClientControllet.ts
